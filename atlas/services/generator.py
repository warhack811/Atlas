...
async def generate_response(
    ...
    intent_system_prompts = ResourceLoader.get_prompt("intent_system_prompts", {})
    cot_suppression_prompt = ResourceLoader.get_prompt("cot_suppression_prompt", "")
    ...
    system_prompt = intent_system_prompts.get(category, intent_system_prompts.get("general", ""))
...
async def generate_stream(
    ...
    system_prompt = override_system_prompt or intent_system_prompts.get(category, intent_system_prompts.get("general", ""))
