...
from atlas.services import rdr
from atlas.services.authentication import create_session_token, decode_session_token, verify_credentials
...
async def startup_event():
    ...
    from atlas.core.scheduler import start_scheduler
    from atlas.core.scheduler import start_scheduler
...
async def chat(request: ChatRequest, background_tasks: BackgroundTasks, user=Depends(get_current_user)):
    ...
    import atlas.core.orchestrator as orchestrator
    import atlas.core.dag_executor as dag_executor
    import atlas.services.synthesizer as synthesizer
    ...
    from atlas.core.governance.safety import safety_gate
    ...
    try:
        ...
        from atlas.core import orchestrator
        ...
        from atlas.core import dag_executor
        ...
        from atlas.services import synthesizer
...
from atlas.core.governance import safety
from atlas.services import rdr
from atlas.memory import SessionManager, MessageBuffer
from atlas.core import orchestrator, dag_executor
from atlas.services import synthesizer
from atlas.memory.neo4j_manager import neo4j_manager
from atlas.memory.request_context import AtlasRequestContext
from atlas.memory.trace import ContextTrace
...
async def upload_image(session_id: str, file: UploadFile = File(...)):
    ...
    try:
        ...
        from atlas.services.vision_engine import analyze_image
...
async def get_notifications(session_id: str, user_id: Optional[str] = None):
    ...
    from atlas.services.observer import observer
